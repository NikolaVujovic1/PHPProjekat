        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="/Website/images/protein2.jpg" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h3>Hydrowhey hardcore</h3>
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <h3>Hydrowhey hardcore</h3>
                            <p class="h3 py-2">7000din</p>
                            <input type="hidden" name="naziv" value="Hydrowhey hardcore">
                            <input type="hidden" name="cena" value="7000 din">
                            <p class="py-2">
                                    ...
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            <li class="list-inline-item text-right">
                                                Kolicina
                                                <input type="hidden" name="product-quanity" id="var-value" value="1">
                                            </li>
                                            <?php
