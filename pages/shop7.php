        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="/Website/images/protein7.jpeg" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <h3>Whey Nutrend</h3>
                            <p class="h3 py-2">2200din</p>
                            <input type="hidden" name="naziv" value="Whey Nutrend">                            
                            <input type="hidden" name="cena" value="2200 din">
                            <p class="py-2">
